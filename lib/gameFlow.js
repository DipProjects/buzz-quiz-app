...
//  * - tiebreak + 2 same-time → 1st answers, 2nd is backup if wrong
//  * - tiebreak + 3+ same-time → tiebreak again among those
//  */
...
//   if (phase === "tiebreak") {
//     if (tied.length === 2) {
//       return openAnsweringWithLineup(tied, 0, prevTiedTeams || allowedIds || tied);
//     }
