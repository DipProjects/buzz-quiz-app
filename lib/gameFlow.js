...
export function funnyBuzzLine(sec) {
  ...
  if (sec > 4) return "Jaldi! Window band hone wali hai…";
  if (sec > 1) return "Last seconds — GO GO GO!";
  return "Times up-ish…";
}

export function funnyAnswerLine(sec) {
  if (sec > 12) return "Socho… lekin zyada sochna mat!";
  if (sec > 6) return "Clock is cooking 🍳";
